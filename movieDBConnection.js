...
export async function checkFilmIDExists(id) {
    try {
        const film = await moviedb.movieInfo(id);
        console.log("ENTERED CHECKfILMExists")
        console.log(film)
        return true;
    } catch (err) {
        ...
        // Other error (e.g., network or API key issue)
